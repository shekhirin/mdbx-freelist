...
pub const BALLASTS_TO_LARGE_VALUES_RATIO: f64 = 1.0;
pub const BALLAST_SIZE_TO_LARGE_VALUE_SIZE_RATIO: f64 = 1.0;
pub const BALLASTS_TO_INSERT: usize =
    (LARGE_VALUES_TO_INSERT as f64 * BALLASTS_TO_LARGE_VALUES_RATIO) as usize;
pub const BALLAST_SIZE: usize =
    (LARGE_VALUE_SIZE as f64 * BALLAST_SIZE_TO_LARGE_VALUE_SIZE_RATIO) as usize;
